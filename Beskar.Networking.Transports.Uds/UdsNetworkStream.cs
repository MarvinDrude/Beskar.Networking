...
/// <summary>
/// Represents a UDS network stream wrapper around an <see cref="IDuplexPipe"/>.
/// </summary>
public sealed class UdsNetworkStream : INetworkStream
{
   ...
   public UdsNetworkStream(INetworkSession session, IDuplexPipe transport)
   {
      Session = session;
   ...
   public ValueTask DisposeAsync()
   {
      ...
      TraceLogger.LogNeutralInfo("UDS Stream: Disposing stream wrapper for session {0}", Session.Id);
      return ValueTask.CompletedTask;
   }
}
