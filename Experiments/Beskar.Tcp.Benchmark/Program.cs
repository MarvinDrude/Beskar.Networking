...
public static class Program
{
   public static async Task Main(string[] args)
   {
      ...
      // ==========================================
      var clientCount = 20; // Total number of raw TCP connections
      var payloadSize = 1024; // Size of the data packet in bytes
      var durationSeconds = 10; // Duration of the benchmark test in seconds
      var serverPort = 9001; // Local port for the TCP server to listen on
      // ==========================================

      Console.ForegroundColor = ConsoleColor.Cyan;
      Console.WriteLine("==================================================================");
      Console.WriteLine("                  BESKAR TCP THROUGHPUT BENCHMARK                 ");
      Console.WriteLine("==================================================================");
      Console.ResetColor();
      ...
      if (bindResult.Failed)
      {
         ...
         Console.WriteLine($"Error starting TCP Listener: {bindResult.Error.Message}");
         Console.ResetColor();
         return;
      }
      ...
      Console.WriteLine($"Connecting {clientCount} TCP clients...");
      var clients = new TcpNetworkClient[clientCount];
      ...
      {
         var clientId = i;
         clients[clientId] = new TcpNetworkClient(options);
      ...
      try
      {
         ...
         Console.WriteLine("All TCP clients connected.");
      }
      catch (Exception ex)
      {
         Console.ForegroundColor = ConsoleColor.Red;
   ...
   private static async Task Cleanup(TcpNetworkListener listener, TcpNetworkClient[] clients,
