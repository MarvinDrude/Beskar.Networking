...
/// <summary>
/// An in-memory implementation of <see cref="INetworkStream"/>.
/// </summary>
public sealed class MemoryNetworkStream : INetworkStream
{
   ...
   public MemoryNetworkStream(INetworkSession session, IDuplexPipe transport)
   {
      Session = session;
   ...
   public ValueTask DisposeAsync()
   {
      ...
      TraceLogger.LogNeutralInfo("Memory Stream: Disposing stream wrapper for session {0}", Session.Id);
      return ValueTask.CompletedTask;
   }
}
