...
public readonly ref partial struct PacketVersion3Parser
{
      ...
      ref PubAckPacket packet)
   {
      ...
      {
         return new StringError("Protocol Violation: PUBACK packet body length must be exactly 2.");
      }
      ...
      var validateResult = PubAckPacketVersion3Validator.Validate(ref packet);
